    ...
    for i in data:
        ...
        if i[0]['type'] == '节点监控':
            if i[0]['name'] == 'POS机':
                ...
                alert_desc = "<td>request:response:forward=" + str(i[0]['total_request']) + ":" + str(i[0]['total_response']) + ":" + str(i[0]['total_forward']) + " 相差" + str(i[0]['differ']) + "</td>"
            elif i[0]['name'] == 'mas':
                alert_desc = "<td>request:response=" + str(i[0]['total_request']) + ":" + str(i[0]['total_response']) + " 相差" + str(i[0]['differ']) + "</td>"
            else:
                alert_desc = "<td>request:response=" + str(i[0]['request']) + ":" + str(i[0]['response']) + " 相差" + str(i[0]['differ']) + "</td>"
        elif i[0]['type'] == 'Sla监控':
        ...
        if i[1]['type'] == '节点监控':
            if i[1]['name'] == 'POS机':
                ...
                alert_desc = "<td>request:response:forward=" + str(i[1]['total_request']) + ":" + str(i[1]['total_response']) + ":" + str(i[1]['total_forward']) + " 相差" + str(i[1]['differ']) + "</td>"
            elif i[1]['name'] == 'mas':
                alert_desc = "<td>request:response=" + str(i[1]['total_request']) + ":" + str(i[1]['total_response']) + " 相差" + str(i[1]['differ']) + "</td>"
            else:
                alert_desc = "<td>request:response=" + str(i[1]['request']) + ":" + str(i[1]['response']) + " 相差" + str(i[1]['differ']) + "</td>"
        elif i[1]['type'] == 'Sla监控':
